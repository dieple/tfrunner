...
resource "aws_rds_cluster" "this" {
  ...
  cluster_identifier                  = var.cluster_use_name_prefix ? null : var.cluster_identifier
  cluster_identifier_prefix           = var.cluster_use_name_prefix ? "${var.cluster_identifier}-" : null
